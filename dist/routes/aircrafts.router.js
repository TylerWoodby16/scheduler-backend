...
exports.aircraftsRouter.get("/", auth_1.verifyToken, (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      if (!database_service_1.collections.aircrafts) throw new Error();
...
exports.aircraftsRouter.post("/", auth_1.verifyToken, (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      if (!database_service_1.collections.aircrafts) throw new Error();
      const result = yield database_service_1.collections.aircrafts.insertOne(
        newAircraft
      );
      result
        ? res
...
exports.aircraftsRouter.put("/:id", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const id =
    ...
    try {
      ...
      if (!database_service_1.collections.aircrafts) throw new Error();
      const result = yield database_service_1.collections.aircrafts.updateOne(
        query,
        { $set: updatedAircraft }
      );
      result
...
exports.aircraftsRouter.put("/updateMany/:name", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _b;
    const name =
    ...
    try {
      ...
      // $set adds or updates all fields
      if (!database_service_1.collections.aircrafts) throw new Error();
      const result = yield database_service_1.collections.aircrafts.updateMany(
        query,
...
//     }
// });
exports.aircraftsRouter.delete("/deleteMany/:name", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _c;
    const name =
    ...
    try {
      const query = { name: name };
      if (!database_service_1.collections.aircrafts) throw new Error();
      const result = yield database_service_1.collections.aircrafts.deleteMany(
        query
      );
      if (result && result.deletedCount) {
